...
def main(args):
    ...
    for i in range(n_set): #n_set : number of set
        ...
        if args.run_single_task is None or args.run_single_task == 3:
            ...
            task3_answer.append(t3_res_pred_move)
            task3_answer.append(t3_res_pred_stay)
            task3_answer.append(t3_res_pred_total)
            save_task3_json(task_num="task3_answer", set_num=args.set_num, pred_data=task3_answer, file_path=args.json_path)
